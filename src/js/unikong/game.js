...
StackExchange.Unikong.Game.prototype = {
    ...
    createWinConditionL1: function () {
        ...
        this.diamonds.add(new StackExchange.Unikong.TreasureItem(this.game, 'diamond', 395, 48, 100, null, diamondParticleEmitter, 750, 25));
        this.diamonds.add(new StackExchange.Unikong.TreasureItem(this.game, 'diamond', 737, 355, 100, null, diamondParticleEmitter, 750, 25));
        this.diamonds.add(new StackExchange.Unikong.TreasureItem(this.game, 'diamond', 47, 355, 100, null, diamondParticleEmitter, 750, 25));
        this.diamonds.add(new StackExchange.Unikong.TreasureItem(this.game, 'diamond', 395, 270, 100, null, diamondParticleEmitter, 750, 25));
        this.diamonds.add(new StackExchange.Unikong.TreasureItem(this.game, 'diamond', 395, 555, 100, null, diamondParticleEmitter, 750, 25));
    },
    createTreasureL1: function() {
        ...
        for (var x = 200; x < 650; x += 50) {
            this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'bronze', x, 630, 10, StackExchange.Unikong.bronzeText, bronzeParticleEmitter, 400, 10));
            this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'bronze', x, 480, 10, StackExchange.Unikong.bronzeText, bronzeParticleEmitter, 400, 10));
        }

        for (var x = 250; x < 600; x += 50) {
            this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'bronze', x, 365, 10, StackExchange.Unikong.bronzeText, bronzeParticleEmitter, 400, 10));
        }

        var silverParticleEmitter = this.game.add.emitter(0, 0, 100);
        silverParticleEmitter.makeParticles('silverParticle');

        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'silver', 18, 365, 25, StackExchange.Unikong.silverText, silverParticleEmitter, 400, 10));
        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'silver', 85, 365, 25, StackExchange.Unikong.silverText, silverParticleEmitter, 400, 10));
        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'silver', 708, 365, 25, StackExchange.Unikong.silverText, silverParticleEmitter, 400, 10));
        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'silver', 775, 365, 25, StackExchange.Unikong.silverText, silverParticleEmitter, 400, 10));

        var goldParticleEmitter = this.game.add.emitter(0, 0, 100);
        goldParticleEmitter.makeParticles('goldParticle');

        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'gold', 18, 235, 50, StackExchange.Unikong.goldText, goldParticleEmitter, 400, 10));
        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'gold', 85, 235, 50, StackExchange.Unikong.goldText, goldParticleEmitter, 400, 10));
        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'gold', 708, 235, 50, StackExchange.Unikong.goldText, goldParticleEmitter, 400, 10));
        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'gold', 775, 235, 50, StackExchange.Unikong.goldText, goldParticleEmitter, 400, 10));
        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'gold', 345, 280, 50, StackExchange.Unikong.goldText, goldParticleEmitter, 400, 10));
        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'gold', 455, 280, 50, StackExchange.Unikong.goldText, goldParticleEmitter, 400, 10));
    },
    ...
    createWinConditionL2: function () {
        ...
        this.diamonds.add(new StackExchange.Unikong.TreasureItem(this.game, 'diamond', 35, 495, 100, null, diamondParticleEmitter, 750, 25));
        this.diamonds.add(new StackExchange.Unikong.TreasureItem(this.game, 'diamond', 395, 335, 100, null, diamondParticleEmitter, 750, 25));
        this.diamonds.add(new StackExchange.Unikong.TreasureItem(this.game, 'diamond', 145, 200, 100, null, diamondParticleEmitter, 750, 25));
        this.diamonds.add(new StackExchange.Unikong.TreasureItem(this.game, 'diamond', 395, 75, 100, null, diamondParticleEmitter, 750, 25));
        this.diamonds.add(new StackExchange.Unikong.TreasureItem(this.game, 'diamond', 675, 200, 100, null, diamondParticleEmitter, 750, 25));
    },
    createTreasureL2: function () {
        ...
        for (var x = 175; x < 625; x += 150) {
            this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'silver', x, 510, 25, StackExchange.Unikong.silverText, silverParticleEmitter, 400, 10));
        }

        var i = 0;
        for (var x = 150; x <= 650; x += 30) {
            if (i % 2 == 0) {
                this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'bronze', x, 400, 10, StackExchange.Unikong.bronzeText, bronzeParticleEmitter, 400, 10));
            } else {
                this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'silver', x, 400, 25, StackExchange.Unikong.silverText, silverParticleEmitter, 400, 10));
            }
            i++;
        }

        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'silver', 30, 215, 25, StackExchange.Unikong.silverText, silverParticleEmitter, 400, 10));
        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'silver', 70 , 215, 25, StackExchange.Unikong.silverText, silverParticleEmitter, 400, 10));
        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'silver', 110, 215, 25, StackExchange.Unikong.silverText, silverParticleEmitter, 400, 10));

        var goldParticleEmitter = this.game.add.emitter(0, 0, 100);
        goldParticleEmitter.makeParticles('goldParticle');

        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'gold', 775, 630, 50, StackExchange.Unikong.goldText, goldParticleEmitter, 400, 10));
        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'gold', 247, 290, 50, StackExchange.Unikong.goldText, goldParticleEmitter, 400, 10));
        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'gold', 540, 290, 50, StackExchange.Unikong.goldText, goldParticleEmitter, 400, 10));
        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'gold', 679, 255, 50, StackExchange.Unikong.goldText, goldParticleEmitter, 400, 10));
        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'gold', 395, 225, 50, StackExchange.Unikong.goldText, goldParticleEmitter, 400, 10));
    },
    ...
    createWinConditionL3: function () {
        ...
        this.diamonds.add(new StackExchange.Unikong.TreasureItem(this.game, 'diamond', 35, 335, 100, null, diamondParticleEmitter, 750, 25));
        this.diamonds.add(new StackExchange.Unikong.TreasureItem(this.game, 'diamond', 345, 215, 100, null, diamondParticleEmitter, 750, 25));
        this.diamonds.add(new StackExchange.Unikong.TreasureItem(this.game, 'diamond', 465, 215, 100, null, diamondParticleEmitter, 750, 25));
        this.diamonds.add(new StackExchange.Unikong.TreasureItem(this.game, 'diamond', 755, 335, 100, null, diamondParticleEmitter, 750, 25));
    ...
    createTreasureL3: function () {
        ...
        for (var x = 100; x < 350; x += 50) {
            this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'bronze', x, 630, 10, StackExchange.Unikong.bronzeText, bronzeParticleEmitter, 400, 10));
            this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'bronze', x + 415, 630, 10, StackExchange.Unikong.bronzeText, bronzeParticleEmitter, 400, 10));
        }
        var silverParticleEmitter = this.game.add.emitter(0, 0, 100);
        silverParticleEmitter.makeParticles('silverParticle');
        ...
        for (var x = 50; x < 350; x += 50) {
            this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'silver', x, 510, 25, StackExchange.Unikong.silverText, silverParticleEmitter, 400, 10));
            this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'silver', x + 465, 510, 25, StackExchange.Unikong.silverText, silverParticleEmitter, 400, 10));
        }

        var goldParticleEmitter = this.game.add.emitter(0, 0, 100);
        goldParticleEmitter.makeParticles('goldParticle');

        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'gold', 350, 630, 50, StackExchange.Unikong.goldText, goldParticleEmitter, 400, 10));
        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'gold', 465, 630, 50, StackExchange.Unikong.goldText, goldParticleEmitter, 400, 10));
        this.treasures.add(new StackExchange.Unikong.TreasureItem(this.game, 'gold', 405, 225, 50, StackExchange.Unikong.goldText, goldParticleEmitter, 400, 10));
    ...
    createTopbar: function () {
        this.scoreText = this.game.add.retroFont('font', 13, 13, Phaser.RetroFont.TEXT_SET3, 36, 2);

        this.game.add.image(450, 20, this.scoreText);
        this.scoreText.text = 'rep ' + score;

        this.game.add.image(605, 20, StackExchange.Unikong.goldText);
        if(!StackExchange.Unikong.goldText.text) StackExchange.Unikong.goldText.text = '0';

        this.game.add.image(680, 20, StackExchange.Unikong.silverText);
        if (!StackExchange.Unikong.silverText.text) StackExchange.Unikong.silverText.text = '0';

        this.game.add.image(755, 20, StackExchange.Unikong.bronzeText);
        if (!StackExchange.Unikong.bronzeText.text) StackExchange.Unikong.bronzeText.text = '0';
        ...
        this.livesText = this.game.add.retroFont('font', 13, 13, Phaser.RetroFont.TEXT_SET3, 36, 2);
        this.game.add.image(80, 20, this.livesText);
    ...
    winWholeGame: function () {
        ...
        var scoreText = this.game.add.retroFont('font', 13, 13, Phaser.RetroFont.TEXT_SET3, 36, 2);
        scoreText.text = Math.random() <= 0.5 ? 'good job' : 'nicely done';
        var img = this.game.add.image(this.game.world.centerX, -10, scoreText);
        img.anchor.setTo(0.5, 0.5);

        this.winSound.play();
        var yayTween = this.game.add.tween(img).to({ y: this.game.world.centerY }, 3000, "Quart.easeOut");
    ...
    yiss: function (player, item) {
        ...
        item.topbarText.text = (+item.topbarText.text + 1).toString(); // lol
        item.kill();
    },
    clean: function() {
        console.log('woof');
...
StackExchange.Unikong.RestartGame.prototype = {
    create: function () {
        score = 0;
        StackExchange.Unikong.level = 1;
        if (!StackExchange.Unikong.goldText) StackExchange.Unikong.goldText = this.game.add.retroFont('font', 13, 13, Phaser.RetroFont.TEXT_SET3, 36, 2);
        if (!StackExchange.Unikong.silverText) StackExchange.Unikong.silverText = this.game.add.retroFont('font', 13, 13, Phaser.RetroFont.TEXT_SET3, 36, 2);
        if (!StackExchange.Unikong.bronzeText) StackExchange.Unikong.bronzeText = this.game.add.retroFont('font', 13, 13, Phaser.RetroFont.TEXT_SET3, 36, 2);
        StackExchange.Unikong.goldText.text = '0';
        StackExchange.Unikong.silverText.text = '0';
        StackExchange.Unikong.bronzeText.text = '0';
        gameSpeedFactor = 1;
...
StackExchange.Unikong.LevelTransition.prototype = {
    create: function () {
        ...
        var txt = this.game.add.retroFont('font', 13, 13, Phaser.RetroFont.TEXT_SET3, 36, 2);

        var img = this.game.add.image(this.game.world.centerX, this.game.world.centerY, txt);
        img.anchor.setTo(0.5);
        txt.text = 'level ' + StackExchange.Unikong.level;
